...
!function(){
  ...
  var fixedPlugin,fixedPluginButton,fixedPluginButtonNav,fixedPluginCard,fixedPluginCloseButton,navbar,buttonNavbarFixed,tooltipTriggerList=[].slice.
  ...
  {
    fixedPlugin.classList.contains("show")?fixedPlugin.classList.remove("show"):
